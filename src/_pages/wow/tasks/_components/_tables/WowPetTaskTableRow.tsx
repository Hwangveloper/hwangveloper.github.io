...
const WowPetTaskTableRow: React.FC<WowPetTaskTableRowProps> = ({ row, onDelete, draggableProvided, draggableStateSnapshot }) => {
  ...
  return (
    <TableRow
      ...
      style={{
        background: draggableStateSnapshot.isDragging ? "#f0f0f0" : "#d9ead3",
